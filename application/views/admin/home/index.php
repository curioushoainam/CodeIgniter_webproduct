			...
			<ul>
				...
				<li>
					<a href="admin/product/?feature=1.html">
						<img src="<?= public_url('admin') ?>/images/icons/control/16/feature.png" />
						<span>Tiêu biểu</span>
					</a>
				</li>
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
			...
			<tbody class="list_item">
					...
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product13.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product7.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product6.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product5.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product4.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product3.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product1.jpg" height="50">
						<div class="clear"></div>
					</div>
					...
					<td>
					<div class="image_thumb">
						<img src="<?= public_url('admin') ?>/upload/product/product2.jpg" height="50">
						<div class="clear"></div>
					</div>
