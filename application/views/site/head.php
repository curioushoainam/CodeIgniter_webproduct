		...
		<link rel="stylesheet" href="<?= public_url() ?>js/jquery/jquery-ui/custom-theme/jquery-ui-1.8.21.custom.css" type="text/css">
	    
        <script src="<?= public_url() ?>site/js/script.js"></script>
