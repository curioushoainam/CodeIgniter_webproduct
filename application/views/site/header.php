<!-- The box-header-->			        
<link type="text/css" href="<?= public_url() ?>js/jquery/autocomplete/css/smoothness/jquery-ui-1.8.16.custom.css" rel="stylesheet">	
<script type="text/javascript" src="<?= public_url() ?>js/jquery/autocomplete/jquery-ui-1.8.16.custom.min.js"></script>
...
<div class="top"><!-- The top -->
	<div id="logo"><!-- the logo -->
	   <a href="" title="Học lập trình website với PHP và MYSQL">
	       <img src="<?= public_url() ?>site/images/logo.jpg" alt="Học lập trình website với PHP và MYSQL">
	   </a>
	</div><!-- End logo -->
	...
	<div id="cart_expand" class="cart"> 
	    ...
	    <img alt="cart bnc" src="<?= public_url() ?>site/images/cart.png"> 
	</div>       
...
<div id="menu"><!-- the menu -->
	<ul class="menu_top">
		...
		<li class=""><a href="<?= public_url() ?>site/info/view/1.html">Giới thiệu</a></li>
		<li class=""><a href="<?= public_url() ?>site/info/view/2.html">Hướng dẫn</a></li>
