...
<p>
 <img style="margin-bottom:-3px" src="<?= public_url()?>site/images/phone.png"> 01686039488	      </p>

<p>
<a rel="nofollow" href="mailto:hoangvantuyencnt@gmail.com">
    <img style="margin-bottom:-3px" src="<?= public_url()?>site/images/email.png"> Email: hoangvantuye...
</a>
</p>
<p>
<a rel="nofollow" href="skype:tuyencnt90">
     <img style="margin-bottom:-3px" src="<?= public_url()?>site/images/skype.png"> Skype: tuyencnt90			</a>
</p>	
</div>			        </div>
</div>
<!-- End Support -->
...
<div class="box-right">
    ...
    <div class="content-box">
		...
		</script><div id="histats_counter_1535" style="display: block;"><a href="http://www.histats.com/viewstats/?sid=2138481&amp;ccid=401" target="_blank"><canvas id="histats_counter_1535_canvas" width="119" height="81"></canvas></a></div></a>
