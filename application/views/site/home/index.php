...
<div class="box-center"><!-- The box-center product-->
	...
	<div class="box-content-center product"><!-- The box-content-center -->
		<div class='product_item'>
			<h3><a href="" title="Sản phẩm">Tivi LG 520</a></h3>

			<div class='product_img'>
				<a  href="san-pham-Tivi-LG-520/9.html" title="Sản phẩm">
					<img src="<?= base_url()?>/upload/product/product13.jpg" alt=''/>
				</a>
			</div>
		...
		<div class='product_item'>
			<h3><a  href="" title="Sản phẩm">Tivi JVC 500</a></h3>

			<div class='product_img'>
				<a  href="san-pham-Tivi-JVC-500/8.html" title="Sản phẩm">
					<img src="<?= base_url()?>/upload/product/product7.jpg" alt=''/>
				</a>
			</div>
			<p class='price'>9,500,000 đ<span class='price_old'>10,000,000 đ</span></p>
		...
		<div class='product_item'>
			<h3><a  href="" title="Sản phẩm">Tivi Toshiba</a></h3>

			<div class='product_img'>
				<a  href="san-pham-Tivi-Toshiba/7.html" title="Sản phẩm">
					<img src="<?= base_url()?>/upload/product/product6.jpg" alt=''/>
				</a>
			</div>
			<p class='price'>5,800,000 đ<span class='price_old'>6,200,000 đ</span></p>
